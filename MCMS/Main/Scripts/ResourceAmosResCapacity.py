...
#############################################################################
#Script which tests the reservation capacity in Amos
...
print "============================================================"
print "Creating 1900 meeting rooms"
num_of_mr = 1900
...
print "============================================================"
print "Creating 2 repeated reservations with 2000 occurrences (total of 4000 reservations)"
num_of_occurences = 2000
...
sleep(20)
c.CheckNumOfReservationsInList(4000)
print "============================================================"
