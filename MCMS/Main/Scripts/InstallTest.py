...
command = "rm /mcms/CACert/*"
os.system(command)
sleep(1)
File=open('Scripts/certificates/certificateCAchain.p7b')
CAcert=File.read()
File.close()

connection.Upload(CAcert ,"/CA/certificateCAchain.p7b")
...
command = "ln -sf " + lsResult("/Carmel-Versions/NonStableBuild/RMX_100.0/last/RMX_*") + " Install/new_version.bin"
print command
os.system(command)
