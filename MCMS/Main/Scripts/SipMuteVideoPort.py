...
print
print "Mute Video by Port in Conf ..."

SipMutePartyVideoPortTest(c, confid, mutedParty, 0)
sleep(10)

mutedParty = 0;
WaitAllButSelfSeesPartyInLayout(c, confid, mutedParty)
print
print "Unmute Video by Port in Conf ..."
SipMutePartyVideoPortTest(c, confid, mutedParty, 0xaac2)
sleep(5)
