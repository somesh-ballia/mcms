...
#### Name   	: Truncate SIP domain from site name #8
...
#### 2. P-Preferred-Identity header contains sitename="TestSiteName@domain.com" Contact display is missing.
#### 3. verify site name is TestSiteName@domain.com.
#### Author		: Arbel M.
#### Reviewer   : Arbel M.
#### Date   	: 15/09/14
class TruncateSipDomainTest_8(SippTest):
	
	def GetSippXmlName(self):
		return "truncateSipDomain_8"
	#--------------------------------
