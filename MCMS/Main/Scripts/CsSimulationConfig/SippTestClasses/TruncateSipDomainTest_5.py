...
#### Name   	: Truncate SIP domain from site name #5
...
#### 2. From header contains sitename="TestSiteName@domain.com" From Display is empty.
#### 3. verify site name is TestSiteName@domain.com.
#### Author		: Arbel M.
#### Reviewer   : Arbel M.
#### Date   	: 15/09/14
class TruncateSipDomainTest_5(SippTest):
	
	def GetSippXmlName(self):
		return "truncateSipDomain_5"
	#--------------------------------
