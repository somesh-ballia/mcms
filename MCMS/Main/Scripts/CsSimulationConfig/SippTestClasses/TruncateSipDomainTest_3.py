...
#### Name   	: Truncate SIP domain from site name #3
...
#### 2. Contact display header contains sitename="TestSiteName" with "@.x.x.x.x".
#### 3. verify site name is TestSiteName.
#### Author		: Arbel M.
#### Reviewer   : Arbel M.
#### Date   	: 15/09/14
class TruncateSipDomainTest_3(SippTest):
	
	def GetSippXmlName(self):
		return "truncateSipDomain_3"
	#--------------------------------
