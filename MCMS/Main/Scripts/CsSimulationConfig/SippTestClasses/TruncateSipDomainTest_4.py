...
#### Name   	: Truncate SIP domain from site name #4
...
#### 2. From Display contains sitename="TestSiteName@domain.com".
#### 3. verify site name is TestSiteName@domain.com.
#### Author		: Arbel M.
#### Reviewer   : Arbel M.
#### Date   	: 15/09/14
class TruncateSipDomainTest_4(SippTest):
	
	def GetSippXmlName(self):
		return "truncateSipDomain_4"
	#--------------------------------
