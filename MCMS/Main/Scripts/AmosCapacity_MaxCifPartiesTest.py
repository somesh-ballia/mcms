...
#*Script_Info_Description="Max CIF participants in Amos 4 cards system (320 parties)"
...
#*export RESOURCE_SETTING_FILE="VersionCfg/Resource_Setting_320CIF_Amos.xml"
