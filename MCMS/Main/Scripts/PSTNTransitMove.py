...
print "Set the Entry Queue " + targetEqName + " To be Transit EQ..."
c.LoadXmlFile("Scripts/CheckTransitEQ/SetTransitEQ.xml")
c.ModifyXml("SET_DEFAULT_EQ","NAME",targetEqName)
c.Send()  
