...
#Copying the Dump File to the local machine

my $scp_command_line = "scp root@".$TargetIP.":/output/core/".$Process." ".$path_to_core_dir ."/".$Process;
system ($scp_command_line) ==0
    or die "scp activation failed\n Status returned was $? and error was $!";
