...
##         os.system(temp_str)   
## #------------------------------------------------------------------------------
##     def test_segment_fault(self,ProcessName,expected_fault,expected_fault_retries_num):
...
##         #return(0)
## #------------------------------------------------------------------------------
##     def test_process__failfault(self,ProcessName,expected_fault,expected_fault_retries_num):
...
## #------------------------------------------------------------------------------
##     def test_reset_mcu(self,ProcessName,expected_fault,expected_fault_retries_num):
##       print " test_process__fail fault ProcessName : "+ ProcessName +"("+str(expected_fault_retries_num) +")."
##       SM_fail = 0
##       fault_elm_list=0
##         #temp_str= str("Bin/McuCmd segment_fault " +ProcessName)
...
## 		           SM_fail = SM_fail+1
##       if SM_fail <> expected_fault_retries_num :
## 	     print "Test failed, RESET_MCU_ON_EXCEPTION not found in Faults"
## 	     #sys.exit(1)
##       #return(0)   
