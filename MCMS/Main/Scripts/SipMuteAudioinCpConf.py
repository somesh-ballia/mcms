...
#WaitAllButSelfSeesPartyInLayout(c, confid, mutedParty)
print
print "Unmute Audio by receive and transmit in Conf ..."
SipMutePartyAudioDirectionTest(c, confid, mutedParty, "receive and transmit")
sleep(10)
...
#WaitAllButSelfSeesPartyInLayout(c, confid, mutedParty)
print
print "Mute Audio by Direction (transmit) in Conf ..."
SipMutePartyAudioDirectionTest(c, confid, mutedParty, "transmit")
sleep(10)
...
#WaitAllButSelfSeesPartyInLayout(c, confid, mutedParty)
print
print "Mute Audio by Inactive in Conf ..."
SipMutePartyAudioInactiveTest(c, confid, mutedParty, "inactive")
sleep(10)
...
print
print "Unmute Audio by receive and transmit in Conf ..."
SipMutePartyAudioInactiveTest(c, confid, mutedParty, "receive and transmit")
sleep(10)
