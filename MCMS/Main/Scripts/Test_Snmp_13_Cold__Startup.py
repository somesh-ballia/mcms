...
def ConfigSnmpdToLocalhost_Community_name2():
	c = UsersUtilities()
	c.ConnectSpecificUser("SUPPORT","SUPPORT")
...
#  Test
#------------------------------------------------------------
print "1.---Restart Simulation in defaults (after set CLEAN_CFG=YES)------------------------------" 
...
KillSnmpListener()
print "3.---Config SNMPD trap destination to local host and set Community name as public1---"
...
areTrapArrived = CheckTrapArrival(outputFile, alertNum,"COLDSTART")
KillSnmpListener()
if(areTrapArrived):
    ...
    print message
    exit(1)
print "7.---Test Passed, we got the COLDSTART trap ---------------------"
exit (0)    
