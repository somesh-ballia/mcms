...
def TestSimInsertCard(connection):
    ...
    if IsCardExist == True:
        ...
        IsCardRemoved = HSUtil_.IsCardRemovedFromHW_List(1, 1) 
...
if IsCardExist == True:
   print ">>> Sim Remove Card"
   j.SendXmlFile('Scripts/CardListMonitor.xml')
   HSUtil.SimRemoveCard(1, 1)        
   sleep(2)
  # exit(0)     
  # test_if_Alert_exist(j,"Resource","INSUFFICIENT_RESOURCES",1) 
   ...
   IsCardRemoved = HSUtil_.IsCardRemovedFromHW_List(1, 2) 
