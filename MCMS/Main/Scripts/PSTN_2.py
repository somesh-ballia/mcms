...
print "________3___Add E1 spans to the old service_________________________"
Add_Span(13,1,"ISDN")
Add_Span(13,5,"ISDN")
Add_Span(13,6,"ISDN")
Add_Span(13,7,"ISDN")

print "________4___Add more E1 spans to the old service( the 8 should fail)"
Add_Span(13,8,"ISDN","Maximum number of ISDN spans connected to this RTM ISDN card has been reached ***")
