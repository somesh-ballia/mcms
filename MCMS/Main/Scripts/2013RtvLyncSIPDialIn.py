...
def TestLyncDailIn(connection,num_of_parties,num_retries,capset="NONE"):
	...
	### UserAgent
	userAgent = "UCCAPI/15.0.4517.1504 OC/15.0.4517.1504 (Microsoft Lync)"
	...
	for x in range(num_of_parties):
		...
		print capset
		connection.SimulationAddSipTelepresenceParty(partyname, confName,userAgent ,capset)
...
TestLyncDailIn(c,1, 2,"SVC_HD720_CAPSET")
