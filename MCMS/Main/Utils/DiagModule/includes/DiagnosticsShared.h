...
#define	EMA_ENTER_DIAG_MODE_REQ		0x300	// 768
#define	EMA_GET_TEST_LIST_REQ 		0x301	// 769
#define	EMA_START_TEST_REQ			0x302	// 770
#define	EMA_GET_UNITS_STATE_REQ		0x303	// 771
#define	EMA_GET_TEST_STATUS_REQ		0x304	// 772
#define	EMA_STOP_TEST_REQ			0x305	// 773
#define	EMA_GET_ERROR_LIST_REQ 		0x306	// 774
