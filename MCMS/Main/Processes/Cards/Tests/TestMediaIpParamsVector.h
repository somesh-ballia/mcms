// TestMediaIpParamsVector.h: interface for the CTestMediaIpParamsVector class.
//
//////////////////////////////////////////////////////////////////////
...
class CTestMediaIpParamsVector   : public CPPUNIT_NS::TestFixture
{
	CPPUNIT_TEST_SUITE( CTestMediaIpParamsVector );
