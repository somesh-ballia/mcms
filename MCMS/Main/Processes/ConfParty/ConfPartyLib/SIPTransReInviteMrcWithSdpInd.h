#if 0
//+========================================================================+
//               SipTransReInviteMrcWithSdpInd.h             	   |
...
//-------------------------------------------------------------------------|
// FILE:       SipTransReInviteMrcWithSdpInd.h                           	   |
// SUBSYSTEM:  MCMS                                                        |
// PROGRAMMER:                                                             |
//-------------------------------------------------------------------------|
...
//     |            |                                                      |
//+========================================================================+
#ifndef SIPTRANSREINVITEMRCWITHSDPIND2_H_
#define SIPTRANSREINVITEMRCWITHSDPIND2_H_

class CSipTransReInviteMrcWithSdpInd : public CSipTransaction
{
CLASS_TYPE_1(CSipTransReInviteMrcWithSdpInd, CSipTransaction)

public:
	CSipTransReInviteMrcWithSdpInd(CTaskApp * pOwnerTask);
	virtual ~CSipTransReInviteMrcWithSdpInd();
	virtual const char* NameOf() const {return "CSipTransReInviteMrcWithSdpInd";}
...
#endif /*SIPTRANSREINVITEMRCWITHSDPIND2_H_*/
