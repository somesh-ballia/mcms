...
//+========================================================================+
#ifndef H323EXPORTPARTYCNTL_
#define H323EXPORTPARTYCNTL_
...
class CH323ExportPartyCntl : public CH323PartyCntl 
{
CLASS_TYPE_1(CH323ExportPartyCntl,CH323PartyCntl )
public: 
	// Constructors
	CH323ExportPartyCntl();
	 ~CH323ExportPartyCntl();  
	
	// Initializations  
	CH323ExportPartyCntl& operator=(const CH323ExportPartyCntl& other);
	CH323ExportPartyCntl& operator =(const CH323PartyCntl& other);
	// Operations
...
//	void  OnXCodeBrdgDisconnect(CSegment* pParam);
	...
	void  OnPartyChannelDisconnect(CSegment* pParam);
	...
	// ReCap event
	void  OnPartyReceivedReCaps(CSegment* pParam);
	// Party connect event
