...
#ifndef   __SIMCARDRXSOCKET_H__
#define   __SIMCARDRXSOCKET_H__
...
class CSimCardRxSocket : public CSocketRxTask
{
CLASS_TYPE_1(CSimCardRxSocket,CSocketRxTask )
public:

				// Constructors
	CSimCardRxSocket();
	virtual const char* NameOf() const { return "CSimCardRxSocket";}
	virtual ~CSimCardRxSocket();
